...
\begin{table*}[t]
\centering
\caption{Effect of the intervention layer on Llama-3-8B (misinformation removal, MMLU). \textit{Base} is the unedited model, \textit{Oracle} is trained only on $\mathcal{D}_r^{\textit{full}}$, and \textit{All} redirects every layer. Layer~6 lies within the band that ROME and MEMIT identify as the site of factual recall in 32-layer Llama models.}
...
$Acc_\textit{f}\!\downarrow$ & 83.70 & N/A & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
\rowcolor{gray!15}
$Acc_\textit{r}\!\uparrow$   & 86.30 & 85.30 & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
\Xhline{1.15pt}
\end{tabular}
\end{table*}
