...
\begin{table*}[t]
\centering
\caption{Effect of the intervention layer on Llama-3-8B (misinformation removal, MMLU). \textit{Base} is the unedited model and \textit{All} redirects every layer. Layer~6 lies within the band that ROME and MEMIT identify as the site of factual recall in 32-layer Llama models.}
\label{tab:layer_ablation}
\small
\renewcommand{\arraystretch}{1.25}
\begin{tabular}{l|c|cccccccc|c}
\Xhline{1.15pt}
\textbf{Metric} & \textbf{Base} & \textbf{L2} & \textbf{L6} & \textbf{L10} & \textbf{L14} & \textbf{L18} & \textbf{L22} & \textbf{L26} & \textbf{L30} & \textbf{All} \\
\Xhline{1.15pt}
% PLACEHOLDERS -- replace with measured values from the layer sweep.
$Acc_\textit{f}\!\downarrow$ & -- & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
\rowcolor{gray!15}
$Acc_\textit{r}\!\uparrow$   & -- & -- & -- & -- & -- & -- & -- & -- & -- & -- \\
\Xhline{1.15pt}
\end{tabular}
\end{table*}
