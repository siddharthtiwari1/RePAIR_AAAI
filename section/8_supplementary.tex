...
def stamp_lr(model, D_f, D_r, D_ref, r=64):
    ...
    set_down_proj(model, W_new)
\end{lstlisting}
\caption{Code snippets for STAMP and STAMP-LR. Comments reference the equations of the main paper.}
