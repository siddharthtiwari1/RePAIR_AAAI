...
\end{lstlisting}
\begingroup
\captionsetup{type=figure, name=Listing, labelsep=bar}
\captionof{figure}{Code snippets for STAMP and STAMP-LR. The comments reference the equations of the main paper, and the helper routines for activation collection and weight replacement are omitted.}
